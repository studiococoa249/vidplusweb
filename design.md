...
export default function DramaShortApp() {
  return (
    <div className="min-h-screen bg-[#07090e] text-gray-200 font-sans selection:bg-[#ffbd59] selection:text-black pb-20 md:pb-0">
      ...
      <header className="fixed top-0 w-full z-50 glass-card px-4 md:px-8 lg:px-12 py-3 md:py-4 flex justify-between items-center shadow-sm">
        {/* Logo */}
        <a href="#" className="text-xl md:text-2xl font-extrabold text-white flex items-center gap-2">
          <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg bg-[#ffbd59] flex items-center justify-center text-black">
            <Zap size={18} className="fill-current" />
          </div>
          Drama<span className="text-[#ffbd59]">Short</span>
        </a>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center gap-8">
          <a href="#" className="text-[#ffbd59] font-semibold transition">Beranda</a>
          <a href="#trending" className="text-gray-400 hover:text-white transition">Trending</a>
          <a href="#romantis" className="text-gray-400 hover:text-white transition">Bikin Baper</a>
          <a href="#aksi" className="text-gray-400 hover:text-white transition">Aksi</a>
        </nav>
      ...
      <main className="max-w-7xl mx-auto pt-24 px-4 md:px-8 lg:px-12 scroll-smooth">
        ...
        <div className="hidden md:block mb-8">
          <h1 className="text-2xl font-bold text-white">Halo, Selamat Datang! 👋</h1>
          <p className="text-gray-400 text-sm mt-1">Temukan drama pendek favoritmu hari ini.</p>
        </div>
        ...
        <section id="trending" className="mb-14">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-white flex items-center gap-2">
              Top Trending <TrendingUp size={24} className="text-[#ffbd59]" />
            </h2>
            <a href="#" className="text-sm text-gray-400 hover:text-[#ffbd59] font-medium transition">Lebih Banyak</a>
          </div>
        ...
        <section id="romantis" className="mb-14">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-white flex items-center gap-2">
              Bikin Baper (Romansa) <Heart size={24} className="text-pink-500 fill-current" />
            </h2>
          </div>
        ...
        <section id="aksi" className="mb-10">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-white flex items-center gap-2">
              Aksi & Bela Diri <Swords size={24} className="text-red-500" />
            </h2>
          </div>
      ...
      <footer className="hidden md:block bg-[#121622] border-t border-white/5 pt-16 pb-12 px-4 md:px-8 lg:px-12 mt-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 lg:col-span-1">
            <a href="#" className="text-2xl font-extrabold text-white flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg bg-[#ffbd59] flex items-center justify-center text-black">
                <Zap size={18} className="fill-current" />
              </div>
              Drama<span className="text-[#ffbd59]">Short</span>
            </a>
            <p className="text-sm text-gray-400 leading-relaxed mb-6">
              Platform streaming eksklusif untuk drama pendek vertikal premium. Nikmati ribuan episode kapan saja, di mana saja dengan kualitas HD.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-semibold mb-5">Jelajahi</h4>
            <ul className="space-y-3 text-sm text-gray-400">
              {['Beranda', 'Top Trending', 'Drama Romantis', 'Aksi & Bela Diri', 'Rilis Terbaru'].map((link, i) => (
                <li key={i}><a href="#" className="hover:text-[#ffbd59] transition flex items-center gap-2"><ChevronRight size={12} /> {link}</a></li>
              ))}
            </ul>
          </div>
          ...
          {/* Support */}
          <div>
            <h4 className="text-white font-semibold mb-5">Bantuan & Legal</h4>
            <ul className="space-y-3 text-sm text-gray-400">
              {['Pusat Bantuan (FAQ)', 'Cara Berlangganan VIP', 'Syarat & Ketentuan', 'Kebijakan Privasi', 'Hubungi Kami'].map((link, i) => (
          ...
          {/* Social */}
          <div>
            <h4 className="text-white font-semibold mb-5">Tetap Terhubung</h4>
            ...
            <p className="text-sm text-gray-400 mb-2">Berlangganan info rilis terbaru:</p>
            <div className="relative">
              <input type="email" placeholder="Email Anda..." className="w-full bg-[#07090e] border border-gray-700 rounded-xl py-2.5 pl-4 pr-12 text-sm text-white focus:outline-none focus:border-[#ffbd59] transition" />
        ...
        <div className="max-w-7xl mx-auto border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500">&copy; 2026 DramaShort Inc. Hak Cipta Dilindungi.</p>
          <div className="flex items-center gap-1 text-xs text-gray-500">
            <span>Didesain dengan</span>
            <Heart size={12} className="text-red-500 fill-current mx-1" />
            <span>untuk pencinta drama.</span>
          </div>
        </div>
      </footer>
