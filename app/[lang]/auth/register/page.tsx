  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#07090e] selection:bg-[#ffbd59] selection:text-black text-gray-200 font-sans">
      ...
      <div className="hidden md:flex w-full md:w-1/2 lg:w-3/5 bg-gradient-to-br from-[#121622] to-[#07090e] items-center justify-center p-12 relative overflow-hidden border-r border-gray-900/50">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
            {lang === 'id' ? 'Mulai Perjalanan Anda.' : 'Start Your Journey.'}
          </h2>
          <p className="text-gray-400 text-lg leading-relaxed">
            {lang === 'id' 
              ? 'Daftar sekarang dan nikmati drama pendek eksklusif dengan kualitas terbaik. Ribuan episode menanti Anda.' 
              : 'Sign up now and enjoy exclusive short dramas in best quality. Thousands of episodes await you.'}
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-between md:justify-center relative w-full md:w-1/2 lg:w-2/5 p-0 md:p-8 bg-[#07090e] md:bg-transparent">
        ...
        <div className="md:hidden h-[25vh] w-full bg-gradient-to-b from-[#121622] to-[#07090e] flex flex-col items-center justify-center relative">
           <img src="/logo.png" alt="Logo" className="h-10 object-contain relative z-10 mb-2" />
           <p className="text-[#ffbd59] font-medium tracking-wide text-xs relative z-10 uppercase">
        ...
        <div className="w-full bg-[#121622] md:bg-[#121622]/80 md:backdrop-blur-xl rounded-t-[2.5rem] md:rounded-2xl -mt-10 md:mt-0 relative z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.3)] md:shadow-2xl md:border md:border-gray-800 p-8 lg:p-12 mx-auto max-w-md flex-1 md:flex-none flex flex-col">
          ...
          <div className="text-center md:text-left mb-6">
            <h1 className="text-2xl font-bold text-white mb-2">
              {lang === 'id' ? 'Buat Akun Baru' : 'Create Account'}
            </h1>
            <p className="text-gray-400 text-sm">
              {lang === 'id' ? 'Lengkapi data di bawah ini' : 'Fill in your details below'}
            </p>
          </div>

          <form action={formAction} className="space-y-5 flex-1">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-[#ffbd59] transition-colors" size={18} />
                <input 
                  type="text" 
                  name="fullName"
                  required
            ...
            <button 
              type="submit" 
              disabled={isPending}
              className="w-full bg-gradient-to-r from-[#ffbd59] to-[#e5a94f] hover:from-[#e5a94f] hover:to-[#ffbd59] text-black font-bold rounded-xl py-3.5 transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#ffbd59]/20 hover:shadow-[#ffbd59]/40 disabled:opacity-70 disabled:cursor-not-allowed mt-6"
            >
              {isPending ? (lang === 'id' ? 'Mendaftar...' : 'Registering...') : (
                <>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            <Link href={`/${lang}/auth/login`} className="text-[#ffbd59] hover:text-white font-medium transition-colors">
