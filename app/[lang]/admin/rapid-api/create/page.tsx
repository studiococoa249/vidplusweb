...
import { createRapidApi } from "../../actions";
import Link from "next/link";
import { ArrowLeft, Save } from "lucide-react";
import { useParams } from "next/navigation";

export default function CreateRapidApiPage() {
  const [state, formAction, isPending] = useActionState(createRapidApi, null);
  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Tambah Rapid API</h1>
          <p className="text-gray-400 text-sm">Masukkan kredensial Rapid API baru</p>
        </div>
      </div>
